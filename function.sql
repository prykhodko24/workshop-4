create type TypeFuncObject as object
(PEOPLE_NAME varchar2(500),COUNTRY_NAME varchar2(10));

create type TypeFuncList as table of TypeFuncObject;
...
begin
  ...
  for i in (SELECT COUNTRY.COUNTRY_NAME,PEOPLE.PEOPLE_NAME
    FROM PEOPLE
 ...
 loop
   pipe row (TypeFuncObject(i.PEOPLE_NAME, i.COUNTRY_NAME));    
  end loop;
